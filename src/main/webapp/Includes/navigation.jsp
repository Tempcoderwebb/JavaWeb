...
<div class="w3-top">
  <div class="w3-bar w3-dark-grey w3-card w3-left-align w3-large">
    ...
    <a href="hello" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Hello</a>
  ...
  <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium w3-large">
    ...
    <a href="hello" class="w3-bar-item w3-button w3-padding-large">Hello</a>
